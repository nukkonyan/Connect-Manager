...
public	void	OnPluginStart()	{
	LoadTranslations("connect_manager.phrases");
	...
	//ConVars
	manager_connect		=	CreateConVar("sm_connect_manager_connect",		"2",	"Determine if connect messages are enabled and wich method to use. \n0 = Disabled \n1 = Enabled - Use OnClientAuthorized \n2 = Enabled - Use OnClientPostAdminCheck",	_,	true,	0.0,	true,	2.0);
	manager_disconnect	=	CreateConVar("sm_connect_manager_disconnect",	"1",	"Determine if disconnect messages should be enabled.");
	
	//Flags
	manager_flag_owner		=	CreateConVar("sm_connect_manager_flag_owner",		"z",	"Owner flag for Connect Manager");
	manager_flag_admin		=	CreateConVar("sm_connect_manager_flag_admin",		"b",	"Admin flag for Connect Manager");
	manager_flag_moderator	=	CreateConVar("sm_connect_manager_flag_moderator",	"o",	"Moderator flag for Connect Manager");
	manager_flag_vip		=	CreateConVar("sm_connect_manager_flag_vip",			"a",	"Vip flag for Connect Manager");
	...
	AutoExecConfig(true,	"connect_manager");
}
